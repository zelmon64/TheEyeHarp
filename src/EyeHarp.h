...
//    stepSeq stepseq;
        void setup(int discNotesNumber, int stepSequencerNotesNumber, bool chordsONOFF, bool showScale,bool scalePreset, bool clickDwell,bool tomidi, bool LoopBeLoopMidi);
